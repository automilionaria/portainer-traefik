...
echo -e "${WHITE} __________              __         .__                      ${RESET}"
echo -e "${WHITE} \______   \____________/  |______  |__| ____   ___________  ${RESET}"
echo -e "${WHITE} |     ___/  _ \_  __ \   __\__  \ |  |/    \_/ __ \_  __ \  ${RESET}"
echo -e "${WHITE} |    |  (  <_> )  | \/|  |  / __ \|  |   |  \  ___/|  | \/  ${RESET}"
echo -e "${WHITE} |____|   \____/|__|   |__| (____  /__|___|  /\___  >__|     ${RESET}"
echo -e "${WHITE}                                 \/        \/     \/         ${RESET}"
echo -e "${WHITE}                                                             ${RESET}"
echo -e "${WHITE}             ___________                     _____.__ __     ${RESET}"
echo -e "${WHITE}   .__      \__    ___/___________    _____/ ____\__|  | __  ${RESET}"
echo -e "${WHITE}  __|  |___    |    |  \_  __ \__  \ _/ __ \   __\|  |  |/ / ${RESET}"
echo -e "${WHITE} /__    __/    |    |   |  | \// __ \\  ___/|  |  |  |    <  ${RESET}"
echo -e "${WHITE}    |__|       |____|   |__|  (____  /\___  >__|  |__|__|_ \ ${RESET}"
                                   \/     \/              \/
